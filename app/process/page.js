...
export default function ProcessPage() {
  const steps = [
    {
      title: 'Discovery',
      copy: 'We begin with a consultation call to understand the property, timeline, and goals. You can share photos, floor plans, or a draft listing.',
    },
    {
      title: 'Site Visit & Estimate',
      copy: 'We walk the property, take measurements, and note light, sightlines, and focal points. You receive a proposed scope, style direction, and fees.',
    },
    {
      title: 'Finalize, Schedule, and Plan',
      copy: 'Once the contract is signed, we confirm install and de-staging dates and start preparing your job one week prior to installation date.',
    },
    {
      title: 'Installation',
      copy: 'Our team curates furnishings, art, and accessories from our private inventory—tailored to the optimal style of the home.',
    },
    // {
    //   title: "Install Day",
    //   copy:
