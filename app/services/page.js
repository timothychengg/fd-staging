    ...
    <main className="min-h-screen bg-luxbg">
      <section className="section-shell border-b border-luxmuted/15 py-14">
        ...
        <h1 className="heading-serif text-3xl mb-3">
          Staging, styling, and design for every listing.
        </h1>
        <p className="max-w-xl text-sm text-luxmuted">
          From vacant luxury homes to lived-in family spaces and new developments, each
      ...
      <section className="section-shell grid gap-6 py-10 text-sm md:grid-cols-2">
        <article className="space-y-2 rounded-2xl border border-luxmuted/15 bg-white p-5">
          <h2 className="text-base font-semibold">Vacant Home Staging</h2>
          <p className="text-luxmuted">
            Ideal for empty homes, investor flips, and new construction. We furnish
            every room to tell a cohesive story and photograph beautifully.
          </p>
        ...
        <article className="space-y-2 rounded-2xl border border-luxmuted/15 bg-white p-5">
          <h2 className="text-base font-semibold">Occupied Staging &amp; Refresh</h2>
          <p className="text-luxmuted">
            Perfect for clients living in the home during the listing period. We work
            with what is there, then add what is needed.
          </p>
          <ul className="ml-5 list-disc space-y-1 text-luxmuted">
        ...
        <article className="space-y-2 rounded-2xl border border-luxmuted/15 bg-white p-5">
          <h2 className="text-base font-semibold">Model Homes &amp; Developments</h2>
          <p className="text-luxmuted">
            For builders and developers seeking cohesive, aspirational model homes and
            amenity spaces that support premium positioning.
          </p>
          <ul className="ml-5 list-disc space-y-1 text-luxmuted">
        ...
        <article className="space-y-2 rounded-2xl border border-luxmuted/15 bg-white p-5">
          <h2 className="text-base font-semibold">Add-On &amp; Advisory</h2>
          <p className="text-luxmuted">
            Additional services that keep the listing process cohesive from prep through
            closing.
          </p>
          <ul className="ml-5 list-disc space-y-1 text-luxmuted">
